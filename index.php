...
echo "<h1>Konw Your Healthful Food!</h1>";
...
switch (strtolower($food)) {
    ...
    case "apple":
        ...
        break;
    case "avocados":
        echo "<h2>Avocados provide healthful fats, as well as g vitamins, vitamin K. and vitamin E.</h2>";
        break;
    case "chicken":
        echo "<h2>Chicken is cost-effective meat that is an excellent source of protein.</h2>";
        break;
    default:
        echo "<h2>Data for $food is not available. Please try again!</h2>";
        break;
}
